-- Database setup script for collaborators
-- Run this script to ensure your database has the required Google auth schema

-- Create database if not exists (run this manually if needed)
-- CREATE DATABASE one_to_multi_agent;
...
-- content_metadataテーブルが存在する場合、user_idカラムを追加
DO $$
BEGIN
